...
exports.getOrder = async (event) => {
    ...
    try{
        ...
        console.error("Error retrieveng order", error);
...
async function sendMessageToSQS(message, queueURL) {
    ...
    try{
        ...
        console.log("message sent successfuly", data.MessageId);
        return data;
    }catch (error){
...
async function saveItemToDynamoDB(item) {
    ...
    try{
        ...
        console.log("Saving item successfuly: ", response);
        return response;
    }catch(error){
...
async function updateStatusInOrder(orderId, status) {
    ...
    try{
        ...
        const response = await docClient.send(command);
        console.log("Item Update successfuly: ", response.Attributes);
...
async function getItemFromDynamoDB(orderId) {
    ...
    try{
        ...
        if(response.Item) {
            console.log("Item retrieved successfuly: ", response.Item);
